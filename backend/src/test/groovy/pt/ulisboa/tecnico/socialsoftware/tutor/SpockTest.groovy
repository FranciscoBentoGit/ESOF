...
class SpockTest extends Specification {
    ...
    public static final String RESPONSE_1 = "A response"
    public static final String NEW_TITLE = "New title"
    public static final String NEW_RESPONSE = "New response"
    ...
    public static final String ICON_1_CONTENT = "Icon 1 Content"
    public static final String ICON_2_CONTENT = "Icon 2 Content"
    public static final String ICON_3_CONTENT = "Icon 3 Content"
    ...
    @Autowired
    IconLeftRepository iconLeftRepository

    @Autowired
    IconRightRepository iconRightRepository
