...
public enum ErrorMessage {
    ...
    INVALID_SEQUENCE_FOR_OPTION("Invalid order for option"),
    INVALID_ORDER_FOR_OPTION("Invalid sequence for option"),
    ...
    INVALID_RESPONSE_FOR_QUESTION("Invalid response for question"),
    ...
    DUPLICATE_ITEM_COMBINATION_QUESTION("Duplicate item combination question"),
    ITEM_COMBINATION_MISSING_ASSOCIATIONS("Right column item not associated with left column item"),
    ITEM_COMBINATION_RIGHT_ASSOCIATION("Right column item associate with two or more items"),
    ITEM_COMBINATION_AT_LEAST_2("Need two or more items per column"),
    NO_CORRECT_OPTION("Question does not have a correct option"),
    WRONG_ORDER_FOR_OPTIONS("Wrong order for options"),
    INVALID_ORDER_FOR_CORRECT_OPTION("All correct options need an order value assigned"),
    ...
    AT_LEAST_TWO_OPTION_NEEDED("Questions need to have at least two options."),
    AT_LEAST_TWO_CORRECT_OPTION_NEEDED("Questions need to have at least 2 correct options"),
