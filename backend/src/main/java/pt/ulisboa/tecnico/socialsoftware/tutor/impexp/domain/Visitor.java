...
public interface Visitor {
    ...
    default void visitQuestionDetails(OpenAnswerQuestion openAnswerQuestion) {}

    default void visitCodeOrderSlot(CodeOrderSlot codeOrderSlot) {}

    default void visitAnswerDetails(OpenAnswerAnswer answer){}

    default void visitLeftIcon(IconLeft icon) {}

    default void visitRightIcon(IconRight icon) {}
