describe('Manage Open Answer Questions Walk-through', () => {
    function validateQuestion(
      ...
      cy.get('[data-cy="showQuestionDialog"]')
        ...
        .within($ls => {
          ...
          cy.get('span > p').should('contain', response);
        });
    }
    ...
    function validateQuestionFull(
      ...
      validateQuestion(title, content, response);
    ...
    it('Creates a new open answer question', function() {
     ...
     cy.get(
         ...
         ).type('Cypress Question Example - Response - 01', { force: true });
    ...
    it('Can update title (with right-click)', function() {
      ...
      validateQuestionFull(
        ...
        (response = 'Cypress Question Example - Response - 01')
      );
    });
    ...
    it('Can update response', function() {
        cy.route('PUT', '/questions/*').as('updateQuestion');
        ...
        cy.get('[data-cy="createOrEditQuestionDialog"]')
          ...
          .within($list => {
            ...
            cy.get('[data-cy="questionResponseTextArea"]')
              .clear({ force: true })
              .type('Cypress New Content For Response!', { force: true });
        ...
        validateQuestionFull(
          (title = 'Cypress Question Example - 01 - Edited'),
          (content = 'Cypress New Content For Question!'),
          (response = 'Cypress New Content For Response!')
        );
      });
    ...
    it('Can duplicate question', function() {
      ...
      cy.get('[data-cy="questionResponseTextArea"]').should(
            'have.value',
            'Cypress New Content For Response!'
       );
